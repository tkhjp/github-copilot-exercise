...
<div class="toc">
  <strong>目次</strong>
  <ol>
    <li><a href="#phase1">Phase 1: 記述モデル比較</a></li>
    <li><a href="#phase1-detail">Phase 1: ケース別詳細 (情報抽出)</a></li>
    <li><a href="#phase2">Phase 2: 回答精度の比較 (情報抽出テスト)</a></li>
    <li><a href="#phase2-judgment">Phase 2: 回答精度の比較 (判断テスト)</a></li>
    <li><a href="#future">今後の課題</a></li>
  </ol>
</div>
